...
int main() {
    int n = 10000;             // NUMERO DE SOMAS A SEREM FEITAS NA SERIE DE TAYLOR
    mpf_t e;                // ATRIBUINDO TIPO DE DADO DE ALTA PRECISÃO PARA EULER(e), AFIM DE OBTER UMA MELHOR PRECISÃO DE CASA DECIAMAIS
    mpf_init2(e,1000000);   // DEFINIMOS AQUI O TAMANHO DA PRECISÃO QUE DESEJAMOS, EM BITS, DO VALOR DE EULER(e)
